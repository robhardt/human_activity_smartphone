Data Dictionary - Human Activity Smartphone Aggregate Dataset
---------------------------------------------------------------
...
The results were then fine-tuned in a text editor.  This code book shows the human-readable field from the ? dataset file, the name of the original feature in the UCI HAR dataset that was averaged to derive this variable, and a brief description of what is being measured.
